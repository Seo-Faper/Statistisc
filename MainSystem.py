...
images = glob.glob('C:/Users/dswhd/Documents/Bandicam/*.jpg')
src = []
answer = list()
...
print('[*]Statistics Shiv Kernel User InterFace ver 0.1[*]')
print('[*] input current PaperNumber \n>')
sel = input()
print('[*] Setting Paper Number to ',sel)
print('[*] Now Need 3 number of General characteristics ')
print('>')
a = input()
b = input()
c = input()
print('[*] General characteristics : ',a,',',b,',',c)
answer.append(a)
answer.append(b)
answer.append(c)
img_path = images[0]
